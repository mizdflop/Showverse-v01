...
Meteor.publish('comments', function (idString) {
  return Comments.find({idString: idString});
});
...
Meteor.publish('episodes', function(idString) {
	console.log(idString);
	return Episodes.find({idString: idString});
});	
