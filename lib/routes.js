...
Router.map(function () {
  this.route('episode_list', {
    path: '/group/:groupName/:seriesTitle', 
    template: "episode_list",
    onBeforeAction: function(){
      if(!Meteor.userId()){
        Router.go("/");
      }
    ...
    waitOn: function () {
          ...
          return [Meteor.subscribe('groups', groupName), 
                  Meteor.subscribe('series', seriesTitle), 
                  Meteor.subscribe('episodes_for_list', seriesTitle)]
          ;
     }
  });
});
    ...
    waitOn: function (){
          ...
          return [
            ...
            Meteor.subscribe('series', seriesTitle, function(){
             ...
             Meteor.subscribe('episodes', idString, function(){
                //console.log( Episodes.find().count());
            }),
            Meteor.subscribe('comments', idString, function(){
